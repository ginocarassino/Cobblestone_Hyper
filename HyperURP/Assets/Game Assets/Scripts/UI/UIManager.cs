...
public class UIManager : MonoBehaviour
{
    ...
    {
        mainMenu.DOAnchorPos(new Vector2(0, -4000), 0.50f);
        shopMenu.DOAnchorPos(new Vector2(0, 0), 0.50f);
    }
    public void CloseShopButton()
    {
        mainMenu.DOAnchorPos(new Vector2(0, 0), 0.50f);
        shopMenu.DOAnchorPos(new Vector2(0, -4000), 0.50f);
    }
    #endregion
    ...
    {
        mainMenu.DOAnchorPos(new Vector2(0, 0), 0.50f);
        settingsMenu.DOAnchorPos(new Vector2(0, 4000), 0.50f);
    }
    #endregion
}
